...
void THFloatVector_conv1dk3(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 2;
...
void THFloatVector_conv1dk4(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 3;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk5(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 4;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk6(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 5;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk7(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 6;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk8(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 7;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk9(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 8;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk10(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 9;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk11(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 10;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk12(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 11;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk13(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 12;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk14(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 13;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk15(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 14;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
void THFloatVector_conv1dk16(float * y, float * x, float * c, float alpha, int n, int reverse){
int i, j;
int xn = n + 15;
float *yptr, *xptr, *cptr;
__m256 ymm0, ymm1, ymm2, ymm6, ymm8, ymm9, ymm10, ymm11, ymm13, ymm14, ymm15;
...
int i; \
switch(cn){ \
case 3: THFloatVector_conv1dk3(y, x, c, alpha, n, reverse); break; \
case 4: THFloatVector_conv1dk4(y, x, c, alpha, n, reverse); break; \
case 5: THFloatVector_conv1dk5(y, x, c, alpha, n, reverse); break; \
case 6: THFloatVector_conv1dk6(y, x, c, alpha, n, reverse); break; \
case 7: THFloatVector_conv1dk7(y, x, c, alpha, n, reverse); break; \
case 8: THFloatVector_conv1dk8(y, x, c, alpha, n, reverse); break; \
case 9: THFloatVector_conv1dk9(y, x, c, alpha, n, reverse); break; \
case 10: THFloatVector_conv1dk10(y, x, c, alpha, n, reverse); break; \
case 11: THFloatVector_conv1dk11(y, x, c, alpha, n, reverse); break; \
case 12: THFloatVector_conv1dk12(y, x, c, alpha, n, reverse); break; \
case 13: THFloatVector_conv1dk13(y, x, c, alpha, n, reverse); break; \
case 14: THFloatVector_conv1dk14(y, x, c, alpha, n, reverse); break; \
case 15: THFloatVector_conv1dk15(y, x, c, alpha, n, reverse); break; \
case 16: THFloatVector_conv1dk16(y, x, c, alpha, n, reverse); break; \
default : \
if(reverse==0) { \
for(i = 0; i < cn; i++) \
THFloatVector_add_unrolled(y, (x + i), (c[i]*alpha), n); } \
else { \
for(i = 0; i < cn; i++) \
THFloatVector_add_unrolled(y, (x + i), (c[-i]*alpha), n); } \
break; \
...
void THDoubleVector_conv1dk3(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 2;
...
void THDoubleVector_conv1dk4(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 3;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk5(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 4;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk6(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 5;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk7(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 6;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk8(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 7;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk9(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 8;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk10(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 9;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk11(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 10;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk12(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 11;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk13(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 12;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk14(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 13;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk15(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 14;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
void THDoubleVector_conv1dk16(double * y, double * x, double * c, double alpha, int n, int reverse){
int i, j;
int xn = n + 15;
double *yptr, *xptr, *cptr;
__m256d ymm0, ymm1, ymm2, ymm3, ymm4, ymm6, ymm8, ymm9, ymm10, ymm11;
...
int i;\
switch(cn){\
case 3: THDoubleVector_conv1dk3(y, x, c, alpha, n, reverse); break;\
case 4: THDoubleVector_conv1dk4(y, x, c, alpha, n, reverse); break;\
case 5: THDoubleVector_conv1dk5(y, x, c, alpha, n, reverse); break;\
case 6: THDoubleVector_conv1dk6(y, x, c, alpha, n, reverse); break;\
case 7: THDoubleVector_conv1dk7(y, x, c, alpha, n, reverse); break;\
case 8: THDoubleVector_conv1dk8(y, x, c, alpha, n, reverse); break;\
case 9: THDoubleVector_conv1dk9(y, x, c, alpha, n, reverse); break;\
case 10: THDoubleVector_conv1dk10(y, x, c, alpha, n, reverse); break;\
case 11: THDoubleVector_conv1dk11(y, x, c, alpha, n, reverse); break;\
case 12: THDoubleVector_conv1dk12(y, x, c, alpha, n, reverse); break;\
case 13: THDoubleVector_conv1dk13(y, x, c, alpha, n, reverse); break;\
case 14: THDoubleVector_conv1dk14(y, x, c, alpha, n, reverse); break;\
case 15: THDoubleVector_conv1dk15(y, x, c, alpha, n, reverse); break;\
case 16: THDoubleVector_conv1dk16(y, x, c, alpha, n, reverse); break;\
default : \
if(reverse==0) { \
for(i = 0; i < cn; i++) \
THDoubleVector_add_unrolled(y, (x + i), (c[i]*alpha), n); } \
else { \
for(i = 0; i < cn; i++) \
THDoubleVector_add_unrolled(y, (x + i), (c[-i]*alpha), n); } \
break; \
